  ...
  create: async (req, res) => {
    try {
      const data = [
        ...
        {
          icon: `<svg fill="none" width="18px" height="19px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M6 2C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2H6Z" stroke="#ffffff" stroke-width="2" stroke-linejoin="round"/><path d="M14 2V8H20" stroke="#ffffff" stroke-width="2" stroke-linejoin="round"/><path d="M8 13H16M8 17H13" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/></svg>`,
          label: "Purchase Orders",
          route: "/purchase-orders/view",
          moduleKey: "purchase_order_management",
        },
        {
          icon: `<svg fill="none" width="18px" height="19px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 1V23M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
          label: "Accounts Purchase Orders",
          route: "/accounts-portal/view",
          moduleKey: "accounts_po_management",
        },
        {
    ...
    try {
      ...
      if (getMenu.length > 0) {
        ...
        const missingModules = [
          ...
          { label: "Accounts Purchase Orders", route: "/accounts-portal/view", moduleKey: "accounts_po_management", icon: `<svg fill="none" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 1V23M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>` },
